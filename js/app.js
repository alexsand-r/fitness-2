(() => {
    ...
    function initSliders() {
        if (document.querySelector(".velokity__slider")) new core(".velokity__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".for__slider")) new core(".for__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".find__slider")) new core(".find__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            grabCursor: true,
            navigation: {
                prevEl: ".top-find__left",
                nextEl: ".top-find__right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".lifestyle__slider")) new core(".lifestyle__slider", {
    ...
    const meetSlider = document.querySelector(".meet__slider");
    let meetSwiper;
    function initMeetSlider() {
        if (meetSlider && window.innerWidth <= 400 && meetSlider.dataset.mobile === "false") {
            meetSwiper = new core(".meet__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.4,
            ...
            meetSlider.dataset.mobile = "true";
        } else if (meetSlider && window.innerWidth > 400) {
            meetSlider.dataset.mobile = "false";
            if (meetSlider.classList.contains("swiper-initialized")) meetSwiper.destroy();
        }
    }
    const stokSlider = document.querySelector(".stok__slider");
    let stokSwiper;
    function initStokSlider() {
        if (stokSlider && window.innerWidth <= 767.98 && stokSlider.dataset.mobile === "false") {
            stokSwiper = new core(".stok__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            stokSlider.dataset.mobile = "true";
        } else if (stokSlider && window.innerWidth > 767.98) {
            stokSlider.dataset.mobile = "false";
            if (stokSlider.classList.contains("swiper-initialized")) stokSwiper.destroy();
        }
    }
    const featuresSlider = document.querySelector(".fit-two__slider");
    let featuresSwiper;
    function initFeaturesSlider() {
        if (featuresSlider && window.innerWidth <= 650 && featuresSlider.dataset.mobile === "false") {
            featuresSwiper = new core(".fit-two__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: false,
                navigation: {
                    prevEl: ".fit-two__left",
                    nextEl: ".fit-two__right"
                },
                on: {}
            });
            featuresSlider.dataset.mobile = "true";
        } else if (featuresSlider && window.innerWidth > 650) {
            featuresSlider.dataset.mobile = "false";
            if (featuresSlider.classList.contains("swiper-initialized")) featuresSwiper.destroy();
        }
    }
        ...
        filterButtons.forEach((button => {
            button.addEventListener("click", (() => {
                ...
                blocks.forEach((block => {
                    if (selectedColor === "all" || selectedColor === block.getAttribute("data-tip")) block.style.display = "block"; else block.style.display = "none";
                }));
            }));
        }));
    }
    function addCommentToTab() {
        var tabElement = document.querySelector(".tab-tab");
        if (tabElement) {
            var commentText = "\x3c!-- " + tabElement.outerHTML + " --\x3e";
            var comment = document.createComment(commentText);
            tabElement.parentNode.replaceChild(comment, tabElement);
        }
    }
    function removeCommentFromTab() {
        var comment = document.querySelector(".tab-tab");
        if (comment && comment.nodeType === Node.COMMENT_NODE) {
            var commentText = comment.nodeValue;
            if (commentText.includes("tab-tab")) comment.parentNode.replaceChild(document.createRange().createContextualFragment(commentText), comment);
        }
    }
    function handleWindowResize() {
        var screenWidth = window.innerWidth;
        if (screenWidth < 450) addCommentToTab(); else removeCommentFromTab();
    }
